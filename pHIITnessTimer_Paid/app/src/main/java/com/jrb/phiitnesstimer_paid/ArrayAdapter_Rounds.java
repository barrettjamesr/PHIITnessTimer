 ...
 */
public class ArrayAdapter_Rounds extends ArrayAdapter{

    private final Context context;
    private final ArrayList<Round> values;

    public ArrayAdapter_Rounds(Context context, int layoutResourceId,  ArrayList<Round> values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textViewRight.setText(String.valueOf(values.get(position).getRoundDisplayTime()));
