...
public class SetupTabata extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_setup_tabata);
        ...
        txtTimeCapRoundMins.setText(TimeFunctions.getMins(PHIIT_preferences.getInt(getString(R.string.DefTabataTimeCap), 0)));
        txtTimeCapRoundSecs.setText(TimeFunctions.getSecs(PHIIT_preferences.getInt(getString(R.string.DefTabataTimeCap), 0)));
        txtRestRoundMins.setText(TimeFunctions.getMins(PHIIT_preferences.getInt(getString(R.string.DefTabataRest), 0)));
        txtRestRoundSecs.setText(TimeFunctions.getSecs(PHIIT_preferences.getInt(getString(R.string.DefTabataRest), 0)));
        spinNumberRounds.setSelection(PHIIT_preferences.getInt(getString(R.string.DefTabataRounds), 2));
        spinNumberExercises.setSelection(PHIIT_preferences.getInt(getString(R.string.DefTabataExercises), 2));
    ...
    public void onClick(View v)  {
        ...
        switch(v.getId()){
            case R.id.btnStart:
                if(validateText()) {
                    i = new Intent(this, RunningTabata.class);
                    savePreferences();
                }
                break;
        ...
        if (i != null)
            SetupTabata.this.startActivity(i);
    }
    ...
    private void savePreferences(){
        ...
        editor.putBoolean(getString(R.string.CheckTabataRest), chkRestRound.isChecked());
        editor.putInt(getString(R.string.ValStartingCD), Integer.valueOf(spinStartingCD.getSelectedItem().toString()));
        editor.putInt(getString(R.string.ValTabataTimeCap), Integer.valueOf(TimeFunctions.totalSecs(txtTimeCapRoundSecs.getText().toString(), txtTimeCapRoundMins.getText().toString())));
        editor.putInt(getString(R.string.ValTabataRest), Integer.valueOf(TimeFunctions.totalSecs(txtRestRoundSecs.getText().toString(), txtRestRoundMins.getText().toString())));
        editor.putInt(getString(R.string.ValTabataRounds), Integer.valueOf(spinNumberRounds.getSelectedItem().toString()));
        editor.putInt(getString(R.string.ValTabataExercises), Integer.valueOf(spinNumberExercises.getSelectedItem().toString()));
